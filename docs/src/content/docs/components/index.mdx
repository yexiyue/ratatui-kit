...
| [Table](/ratatui-kit/components/table/) | Data-driven table with cell-grid borders, wrapping, and row/column highlight | Bordered/markdown tables and structured grids |
