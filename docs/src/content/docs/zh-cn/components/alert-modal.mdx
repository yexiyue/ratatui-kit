...
![alert modal demo](/ratatui-kit/zh-cn/recordings/alert-modal.gif)
...
需要让用户做选择时，用 [ConfirmModal](/ratatui-kit/zh-cn/components/confirm-modal/)；需要展示多组快捷键时，看后续 `ShortcutInfoModal`。
