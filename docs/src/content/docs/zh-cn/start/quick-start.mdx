...
这一页只做一件事：跑起第一个界面。如果你还没有把依赖放进自己的 `Cargo.toml`，先看 [安装与功能门控](/ratatui-kit/zh-cn/start/installation/)。如果你正在本仓库里学习，可以直接运行 example。

![hello world demo](/ratatui-kit/zh-cn/recordings/hello-world.gif)
...
继续看 [心智模型](/ratatui-kit/zh-cn/start/mental-model/) 了解这三个名字如何协作；如果你更想直接写交互，可以跳到第一个会动的 [计数器教程](/ratatui-kit/zh-cn/tutorials/counter/)。
